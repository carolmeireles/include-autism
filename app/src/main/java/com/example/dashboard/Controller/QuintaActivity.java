    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(QuintaActivity.this, InserirImagemActivity.class);
        ...
        bt_salvar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(QuintaActivity.this, DiasSemanaActivity.class);
                startActivity(intent);
            }
        });
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()){
            case R.id.menuInicial:{
                Intent intent = new Intent(QuintaActivity.this, DashboardActivity.class);
                startActivity(intent);
                return true;
