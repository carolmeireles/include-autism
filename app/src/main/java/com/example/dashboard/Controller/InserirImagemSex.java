...
public class InserirImagemSex extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.inseririmagemsex);
    ...
    protected void onStart() {
        ...
        bt_selecionar.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(InserirImagemSex.this, Sexta_activity.class);
