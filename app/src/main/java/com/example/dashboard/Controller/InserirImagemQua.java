...
public class InserirImagemQua extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.inseririmagemqua);
    ...
    protected void onStart() {
        ...
        bt_selecionar.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(InserirImagemQua.this, Quarta_activity.class);
