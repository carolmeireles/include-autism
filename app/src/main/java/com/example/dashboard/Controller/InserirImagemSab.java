...
public class InserirImagemSab extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.inseririmagemsab);
    ...
    protected void onStart() {
        ...
        bt_selecionar.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(InserirImagemSab.this, Sabado_activity.class);
