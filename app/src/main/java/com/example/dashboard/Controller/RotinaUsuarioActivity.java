...
public class RotinaUsuarioActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        segunda.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(RotinaUsuarioActivity.this, SegundaUsuarioActivity.class);
       ...
       terca.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(RotinaUsuarioActivity.this, TercaUsuarioActivity.class);
                startActivity(intent);
            }
        });
       ...
       quarta.setOnClickListener(new View.OnClickListener() {
           @Override
           public void onClick(View view) {
               Intent intent = new Intent(RotinaUsuarioActivity.this, QuartaUsuarioActivity.class);
               startActivity(intent);
           }
       });
       ...
       quinta.setOnClickListener(new View.OnClickListener() {
           @Override
           public void onClick(View view) {
               Intent intent = new Intent(RotinaUsuarioActivity.this, QuintaUsuarioActivity.class);
               startActivity(intent);
           }
       });
       ...
       sexta.setOnClickListener(new View.OnClickListener() {
           @Override
           public void onClick(View view) {
               Intent intent = new Intent(RotinaUsuarioActivity.this, SextaUsuarioActivity.class);
               startActivity(intent);
           }
       });
       ...
       sabado.setOnClickListener(new View.OnClickListener() {
           @Override
           public void onClick(View view) {
               Intent intent = new Intent(RotinaUsuarioActivity.this, SabadoUsuarioActivity.class);
               startActivity(intent);
           }
       });
       ...
       domingo.setOnClickListener(new View.OnClickListener() {
           @Override
           public void onClick(View view) {
               Intent intent = new Intent(RotinaUsuarioActivity.this, DomingoUsuarioActivity.class);
               startActivity(intent);
           }
       });
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()){
            case R.id.menuInicial:{
                Intent intent = new Intent(RotinaUsuarioActivity.this, DashboardActivity.class);
                startActivity(intent);
                return true;
