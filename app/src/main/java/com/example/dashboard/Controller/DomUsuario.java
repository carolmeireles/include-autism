...
public class DomUsuario extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.domusuario);
    ...
    protected void onStart() {
        ...
        img1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                referencia.child("InserirRotina").child("Domingo").child(id)
                        .child("0").removeValue();
                Toast.makeText(getApplicationContext(), "Rotina realizada com sucesso!", Toast.LENGTH_SHORT).show();
                Intent intent = new Intent(DomUsuario.this, DomUsuario.class);
    ...
    public void recuperar(){
        DatabaseReference reference = database.getReference().child("InserirRotina").child("Domingo")
                .child(id);
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()){
            case R.id.menuInicial:{
                Intent intent = new Intent(DomUsuario.this, DashboardActivity.class);
                startActivity(intent);
                return true;
