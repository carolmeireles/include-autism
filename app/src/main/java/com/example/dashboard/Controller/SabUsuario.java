...
public class SabUsuario extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.sabusuario);
    ...
    protected void onStart() {
        ...
        img1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                referencia.child("InserirRotina").child("Sabado").child(id)
                        .child("0").removeValue();
                Toast.makeText(getApplicationContext(), "Rotina realizada com sucesso!", Toast.LENGTH_SHORT).show();
                Intent intent = new Intent(SabUsuario.this, SabUsuario.class);
    ...
    public void recuperar(){
        DatabaseReference reference = database.getReference().child("InserirRotina").child("Sabado")
                .child(id);
