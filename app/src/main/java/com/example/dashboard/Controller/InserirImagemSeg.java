...
public class InserirImagemSeg extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.inseririmagemseg);
    ...
    protected void onStart() {
        ...
        bt_selecionar.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(InserirImagemSeg.this, Segunda_Activity.class);
