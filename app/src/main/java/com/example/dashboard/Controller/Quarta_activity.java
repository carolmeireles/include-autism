...
public class Quarta_activity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(Quarta_activity.this, InserirImagemQua.class);
        ...
        bt_salvar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(Quarta_activity.this, DiasSemana_activity.class);
                startActivity(intent);
            }
        });
    ...
    public void salvar() {
        ...
        for (int i = 0; i < imagemRecebida.size(); i++) {
            referencia.child("InserirRotina").child("QuartaFeira")
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()){
            case R.id.menuInicial:{
                Intent intent = new Intent(Quarta_activity.this, DashboardActivity.class);
                startActivity(intent);
                return true;
