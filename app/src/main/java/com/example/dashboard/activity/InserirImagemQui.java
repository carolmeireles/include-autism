...
public class InserirImagemQui extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.inseririmagemqui);
    ...
    protected void onStart() {
        ...
        bt_selecionar.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(InserirImagemQui.this, Quinta_activity.class);
