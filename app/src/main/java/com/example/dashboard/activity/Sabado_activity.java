...
public class Sabado_activity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.sabado_activity);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(Sabado_activity.this, InserirImagemSab.class);
        ...
        bt_salvar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(Sabado_activity.this, DiasSemana_activity.class);
                startActivity(intent);
            }
        });
    ...
    public void salvar() {
        ...
        for (int i = 0; i < imagemRecebida.size(); i++) {
            referencia.child("InserirRotina").child("Sabado")
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()){
            case R.id.menuInicial:{
                Intent intent = new Intent(Sabado_activity.this, DashboardActivity.class);
                startActivity(intent);
                return true;
