...
public class QuiUsuario extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.quiusuario);
    ...
    protected void onStart() {
        ...
        img1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                referencia.child("InserirRotina").child("QuintaFeira").child(id)
                        .child("0").removeValue();
                Toast.makeText(getApplicationContext(), "Rotina realizada com sucesso!", Toast.LENGTH_SHORT).show();
                Intent intent = new Intent(QuiUsuario.this, QuiUsuario.class);
    ...
    public void recuperar(){
        DatabaseReference reference = database.getReference().child("InserirRotina").child("QuintaFeira")
                .child(id);
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()){
            case R.id.menuInicial:{
                Intent intent = new Intent(QuiUsuario.this, DashboardActivity.class);
                startActivity(intent);
                return true;
