...
public class Terca_activity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.terca_activity);
        fab = (FloatingActionButton) findViewById(R.id.fab);
        bt_salvar = (Button) findViewById(R.id.bt_salvarT);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(Terca_activity.this, InserirImagemTer.class);
        ...
        bt_salvar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(Terca_activity.this, DiasSemana_activity.class);
                startActivity(intent);
            }
        });
    ...
    public void salvar() {
        ...
        for (int i = 0; i < imagemRecebida.size(); i++) {
            referencia.child("InserirRotina").child("TercaFeira")
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()){
            case R.id.menuInicial:{
                Intent intent = new Intent(Terca_activity.this, DashboardActivity.class);
                startActivity(intent);
                return true;
